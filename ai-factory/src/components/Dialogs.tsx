    ...
    <Modal open={open} onClose={onClose} code="СПРАВКА" title="Справочник инженера" icon={BookOpen} width="max-w-2xl">
      <div className="flex flex-col gap-4">
        ...
        <Section title="Рынок, НИОКР и рекорды">
          ...
          <p>
            Рекорды хранятся в localStorage и переживают сброс фабрики. «Максимальный пассивный доход» — среднее за 10
            секунд, причём продажа моделей учитывается не больше их текущего выпуска: распродажа накопленного склада
            приносит деньги, но рекорд не накручивает. «Запущено узлов за всё время» растёт, когда новый узел отработал
            {' '}{BAL.commissionTicks} секунд. Контрактов: {GOALS.length}, каждый приносит награду.
          </p>
        </Section>
