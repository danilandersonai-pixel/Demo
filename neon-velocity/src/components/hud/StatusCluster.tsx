  ...
  return (
    <div className="flex min-w-0 items-start justify-end gap-2 sm:gap-3">
      <div className="flex min-w-0 flex-col items-end">
        <div className="nv-digits flex items-baseline gap-1.5 whitespace-nowrap text-[10px] font-bold tracking-widest sm:text-xs">
          <motion.span
            key={level}
        ...
        <div className="mt-1 h-1 w-[5.5rem] overflow-hidden rounded-[1px] bg-white/10 sm:mt-1.5 sm:h-1.5 sm:w-40">
          <div
            key={level}
