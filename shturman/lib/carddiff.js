...
// Максимум строк диффа в одной карточке. Живая проверка показала: при 24
// строках карточка превращается в простыню и ломает ритм ленты; 14 строк
// хватает увидеть суть правки, остальное — в подробностях.
var CARD_LINES = 14;
