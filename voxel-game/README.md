...
Сенсорное управление включается автоматически на touch-устройствах:

| Действие | Жест |
|---|---|
| Ходьба | левый виртуальный джойстик |
| Обзор | перетаскивание правой части экрана |
| Сломать / поставить | кнопки ⛏ / ▦ (удержание — повтор) |
| Прыжок / вверх, вниз | кнопки ⤒ / ⤓ |
| Режим полёта | кнопка ✈ |
| Выбор блока | тап по слоту хотбара |
| Пауза | кнопка ⏸ (вверху справа) |

Лучше играть в **горизонтальной ориентации**.
